    ...
    >
      ...
      {!book.coverImage && (
        <div style={{ position:'absolute', inset:0, display:'flex', alignItems:'center', justifyContent:'center', padding:'6px 4px 6px 9px' }}>
          <p style={{ fontSize:'9px', color:'rgba(255,255,255,0.85)', writingMode:'vertical-rl', textOrientation:'mixed', lineHeight:1.2, fontWeight:'700', overflow:'hidden', maxHeight:'100%', fontFamily:"'Manrope',sans-serif" }}>
            {book.title}
          </p>
        </div>
      )}
  ...
  return (
    <div style={{ marginBottom:'52px' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'14px' }}>
        ...
        <div>
          <h3 style={{ fontSize:'16px', fontWeight:'700', color:'var(--text-1)', fontFamily:"'Bodoni Moda',serif", lineHeight:1 }}>{category}</h3>
      ...
      <div style={{ display:'flex', gap:'14px', marginBottom:'28px', flexWrap:'wrap' }}>
        {[
          ...
          <div key={s.label} style={{ background:'var(--bg-card)', border:'1px solid var(--border)', borderRadius:'10px', padding:'12px 20px', display:'flex', alignItems:'center', gap:'12px' }}>
            ...
            <div>
              <p style={{ fontFamily:"'Bodoni Moda',serif", fontSize:'24px', color:'var(--text-1)', lineHeight:1 }}>{s.value}</p>
      ...
      {selected && (
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.75)', display:'flex', alignItems:'center', justifyContent:'center', zIndex:300, padding:'24px' }}
          ...
          <div style={{ background:'var(--bg-card)', border:'1px solid var(--border)', borderRadius:'16px', padding:'28px', maxWidth:'440px', width:'100%', display:'flex', gap:'20px', position:'relative' }}
            ...
            <div style={{ flex:1 }}>
              <h2 style={{ fontSize:'18px', fontWeight:'700', color:'var(--text-1)', marginBottom:'3px', fontFamily:"'Bodoni Moda',serif", lineHeight:1.2 }}>{selected.title}</h2>
              ...
              {selected.shelfNumber && (
                <div style={{ display:'flex', alignItems:'center', gap:'7px', background:'rgba(245,158,11,0.12)', border:'1px solid rgba(245,158,11,0.3)', borderRadius:'8px', padding:'8px 12px', marginBottom:'12px' }}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#b8863f" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                  <span style={{ fontSize:'12px', fontWeight:'700', color:'#b8863f' }}>Shelf {selected.shelfNumber}</span>
                </div>
              )}
