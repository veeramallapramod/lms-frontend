...
const PLAN_INFO = {
  ...
  PREMIUM:  { label:'Premium',  price:'₹399/mo', books:20, color:'#f59e0b' },
};
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
          ...
          <div className="card" style={{ padding:'22px', borderTop:`3px solid ${selectedPlan.color}` }}>
            ...
            <div style={{ display:'flex', alignItems:'baseline', gap:'4px', marginBottom:'14px' }}>
              <span style={{ fontFamily:'Instrument Serif, serif', fontSize:'28px', color:'var(--text-1)' }}>{selectedPlan.price}</span>
            </div>
            {[
