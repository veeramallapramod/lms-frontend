...
const PLAN_COLORS = { FREE:'#94a3b8', BASIC:'#3b82f6', STANDARD:'#8b5cf6', PREMIUM:'#b8863f' };
        ...
        <div style={{ display:'flex', gap:'4px', background:'var(--bg-card)', padding:'4px', borderRadius:'10px', border:'1px solid var(--border)' }}>
          {tabs.map(tab => (
            <button key={tab} onClick={() => setFilter(tab)} style={{
              ...
              fontSize:'12px', fontWeight:'500', fontFamily:"'Manrope',sans-serif",
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'12px', marginBottom:'20px' }}>
        {[
          ...
          <div key={s.label} className="card" style={{ padding:'14px 18px', display:'flex', gap:'12px', alignItems:'center' }}>
            ...
            <div>
              <p style={{ fontSize:'22px', fontWeight:'800', color:'var(--text-1)', fontFamily:"'Bodoni Moda',serif", lineHeight:1 }}>{s.value}</p>
              ...
              {editUser.role === 'MEMBER' && (
                <div>
                  ...
                  <select value={editForm.subscriptionPlan}
                    ...
                    style={{ width:'100%', background:'var(--bg-input)', border:'1px solid var(--border)', borderRadius:'8px', padding:'10px 14px', color:'var(--text-1)', fontFamily:"'Manrope',sans-serif", fontSize:'14px', outline:'none' }}>
