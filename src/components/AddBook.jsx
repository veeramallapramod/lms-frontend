            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'16px' }}>
              <Field label="Category *" error={errors.category}>
                <select name="category" value={form.category} onChange={handleChange}
                  style={{ width:'100%', background:'var(--bg-input)', border:`1px solid ${errors.category ? 'var(--red)' : 'var(--border)'}`, borderRadius:'8px', padding:'10px 14px', color: form.category ? 'var(--text-1)' : 'var(--text-3)', fontFamily:"'Manrope',sans-serif", fontSize:'14px', outline:'none' }}>
              ...
              <Field label="Shelf Number *" error={errors.shelfNumber}>
                ...
                <div style={{ display:'flex', gap:'8px' }}>
                  <select name="shelfNumber" value={form.shelfNumber} onChange={handleChange}
                    style={{ flex:1, background:'var(--bg-input)', border:`1px solid ${errors.shelfNumber ? 'var(--red)' : 'var(--border)'}`, borderRadius:'8px', padding:'10px 14px', color: form.shelfNumber ? 'var(--text-1)' : 'var(--text-3)', fontFamily:"'Manrope',sans-serif", fontSize:'14px', outline:'none' }}>
